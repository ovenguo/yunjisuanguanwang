...
<script type="text/javascript">
function getdata(id){
$.post("/cloude/index.php/Index/News/noticearticle_data?id="+id,{},function(data){
  $('#title').text(data['news']['title']);
  $('#date').text("发布日期："+data['news']['date']);
  $('#content').html(data['news']['content']);
  $('#username').text("编辑："+data['news']['username']);
  $('#ftSize1').text(data['news']['type']);
...
$(function(){
$.post("/cloude/index.php/Index/News/noticearticle_data",{},function(data){
      ...
      <div class="navi">
        ...
        <div class="top-nav"> <span class="menu"><img src="__PUBLIC__/images/menu.png" alt="" /></span>
          <ul id="mg1" class="nav1">
            ...
            <li><a id="ftSize1" href="<?php echo U('Index/News/news');?>" class=""></a></li>
